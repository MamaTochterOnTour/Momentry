...
import '../erstellen_tab/edit_post_page.dart';
import '../profil_tab/premium_verwalten_page.dart';
import '../l10n/s.dart';
import 'feed_video_post_payer.dart';
...
class _PostCardState extends State<PostCard>
  ...
  Future<void> _showSaveToTripSheet(String postId) async {
        ...
        return SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Wo möchtest du diese Inspiration speichern?",
                ...
                if (tripsSnap.docs.isEmpty)
                  Text(
                    "Du hast noch keine Reisen angelegt.",
                    style: TextStyle(color: textColor.withValues(alpha: 0.6)),
                  ),

                ...tripsSnap.docs.map((trip) {
                ...
                ListTile(
                  ...
                  onTap: () {
                    ...
                    MainNavigationPage.openCreateTrip(pageContext);
                  },
                ),
              ],
            ),
          ...
          children: List.generate(mediaUrls.length, (index) {
            return AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                color: _currentPage == index ? Color(0xFF8C77FF) : Colors.grey,
              ),
            );
          }),
        ),
                            ...
                            children: [
                              ...
                              if (!_isExpanded &&
                                ...
                                TextSpan(
                                  ...
                                  style: TextStyle(color: Color(0xFF8C77FF)),
                                ),
                            ],
                          ),
                        ),
                    ...
                    Row(
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Row(
                            children: [
                              Icon(Icons.comment, color: Color(0xFF8C77FF)),
                              const SizedBox(width: 4),
                                ...
                                return GestureDetector(
                                  onTap: () async {
                                              ...
                                              const Expanded(
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(height: 2),
                                                    Text(
                                                      "Du hast bereits 5 Beiträge gespeichert.\nTippe hier für unbegrenzte Speicherplätze.",
                                                      style: TextStyle(
                                    ...
                                    if (isSaved) {
                                      ...
                                      // 1. Aus Profil-Inspirationen entfernen
                                      ...
                                      for (final trip in tripsSnapshot.docs) {
                                        ...
                                        final savedPosts = List<dynamic>.from(
                                          tripData['savedPosts'] ?? [],
                                        );
                                      ...
                                      // maximal 5 kostenlose Speicherplätze

                                      if (!isPremium &&
                                          userSavedPosts.length >= 5) {
                                        final snackBar = SnackBar(
                                          content: const Text(
                                            "Du hast bereits 5 Inspirationen gespeichert. "
                                            "Mit Premium kannst du unbegrenzt speichern.",
                                          ),
                                      ...
                                      // NEU:
                                      // danach fragen, welcher Reise es hinzugefügt wird

                                      await _showSaveToTripSheet(
                                        widget.post['id'],
                                      );
