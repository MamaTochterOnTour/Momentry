...
import 'aidacosma_med_schaetze_2_page.dart';

class AidaKreuzfahrtenPage extends ConsumerWidget {
  final String userId;

  const AidaKreuzfahrtenPage({super.key, required this.userId});
          ...
          children: [
            ...
            GridView.count(
              ...
              children: [
                ...
                _buildKreuzfahrtThumbnail(
                  imageUrl:
                      "https://firebasestorage.googleapis.com/v0/b/reiseapp-mamatocherontour.firebasestorage.app/o/guides_bilder%2FMed.Schaetze2Thumbnail.png?alt=media&token=6e7c34f0-573f-443e-91b6-b53b2c7eec5d",
                  onTap: () => checkPremiumAndNavigate(
                    context,
                    MediterraneSchaetze2Page(isDarkMode: isDarkMode),
                  ),
                ),
              ],
            ),
