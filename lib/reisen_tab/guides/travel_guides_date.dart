...
final List<Product> travelGiudes = [
  ...
  Product(
    id: '20',
    name: '✨ Cagliari Insider Guide',
    price: 4.99,
    description:
        'Cagliari ist viel mehr als nur ein Zwischenstopp auf Sardinien. Dieser Guide zeigt dir die Stadt so, wie wir sie erlebt haben – mit echten Lieblingsorten, besonderen Highlights, schönen Aussichtspunkten und persönlichen Empfehlungen für deinen Aufenthalt.\n\nStatt einer einfachen Liste von Sehenswürdigkeiten bekommst du eine klare und strukturierte Übersicht über die wichtigsten Orte in Cagliari, charmante Gassen, lokale Märkte, kulinarische Highlights und praktische Tipps für deinen Besuch.\n\nOb historische Altstadt, mediterranes Lebensgefühl, beeindruckende Ausblicke über das Meer oder sardische Spezialitäten – dieser Guide hilft dir dabei, Cagliari entspannt, authentisch und intensiver zu entdecken.\n\nPerfekt für alle, die Cagliari nicht nur kurz besuchen, sondern die besondere Atmosphäre dieser wunderschönen Stadt wirklich erleben möchten.',
    imageUrl:
        'https://firebasestorage.googleapis.com/v0/b/reiseapp-mamatocherontour.firebasestorage.app/o/guides_bilder%2FCagliariThumbnail.png?alt=media&token=6d9894cc-372d-475f-bbf1-51ca56b8e686',
    tab: 2,
    rcProductId: 'CagliariGuide',
    pdfUrl:
        'https://firebasestorage.googleapis.com/v0/b/reiseapp-mamatocherontour.firebasestorage.app/o/travel_guides%2FCagliariGuide.pdf?alt=media&token=820aae09-7a7d-4f2f-992b-a831fed86fdf',
    categories: ['italien'],
  ),
];
