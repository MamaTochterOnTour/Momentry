...
class QATab extends StatefulWidget {
  ...
  const QATab({super.key, this.openQuestionId});
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _QuestionCard(
                    questionId: doc.id,
                    data: data,
                    autoOpen: widget.openQuestionId == doc.id,
                  );
                },
              );
            },
...
class _QuestionCardState extends ConsumerState<_QuestionCard> {
  ...
  void didChangeDependencies() {
    ...
    if (widget.autoOpen && !_alreadyOpened) {
      _alreadyOpened = true;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(data['question'] ?? '', style: const TextStyle(fontSize: 17)),
