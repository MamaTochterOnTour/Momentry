...
class _PostsPageState extends ConsumerState<PostsPage>
  ...
  Stream<QuerySnapshot> _storiesStream() {
    return _firestore
        ...
        .where("forumRegion", isEqualTo: widget.region)
        .where("forumCountry", isEqualTo: widget.country)
        .where("forumTopic", isEqualTo: widget.topic)
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: isSearching
            ...
            : Text(
                widget.isGeneral ? widget.topic : widget.country,
